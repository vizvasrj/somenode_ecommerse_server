...
router.post('/add', auth, role.check(ROLES.Admin, ROLES.Merchant), async (req, res) => {
  console.log("HERE i can add brand")
  try {
...
router.get('/list', async (req, res) => {
  console.log("HERE i can get List of brands")
  try {
...
router.get(
  ...
  async (req, res) => {
    console.log("I dont knwo why is this here.")
    try {
      let brands = null;
      ...
      if (req.user.merchant) {
        ...
        console.log("brands from req.user.merchant", brands)
      } else {
        brands = await Brand.find({}).populate('merchant', 'name');
        console.log("brands from else", brands)
      }
